...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-9 w-max items-center justify-center rounded-md bg-background px-4 py-2 text-sm font-medium text-black dark:text-white hover:bg-accent hover:text-chart-3 dark:hover:text-chart-2 focus:bg-accent focus:text-chart-3 dark:focus:text-chart-2 disabled:pointer-events-none disabled:opacity-50 data-[active]:text-primary data-[popup-open]:hover:bg-accent data-[popup-open]:text-chart-3 dark:data-[popup-open]:text-chart-2 data-[popup-open]:focus:bg-accent data-[popup-open]:bg-accent/50 focus-visible:ring-ring/50 outline-none transition-[color,box-shadow] focus-visible:ring-[3px] focus-visible:outline-1"
);
...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        "text-black dark:text-white data-[active]:text-primary focus:bg-accent hover:bg-accent data-[active]:bg-accent/50 hover:text-chart-3 dark:hover:text-chart-2 focus:text-chart-3 dark:focus:text-chart-2 focus-visible:ring-ring/50 [&_svg:not([class*='text-'])]:text-muted-foreground flex flex-col gap-1 rounded-sm p-2 text-sm transition-all outline-none focus-visible:ring-[3px] focus-visible:outline-1 [&_svg:not([class*='size-'])]:size-4",
        className
      )}
      {...props} />
  );
